        ...
        <div className="container py-5">
            <div className="row py-4">
                <div className="col-12 col-lg-6 py-2">
                    ...
                    <p className="hero-desc text-white text-capitalize fw-normal m-0 pe-xl-5">NFT marketplace UI created with Anima for Figma. Collect, buy and sell art from more than 20k NFT artists.</p>
