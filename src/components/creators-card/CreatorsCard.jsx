import {Link, preventScrollReset} from 'react-router-dom'

export const CreatorsCardDesktop = ({id, name, image, sales}) => {
    return (
        <Link to={`rankings/${name}`} preventScrollReset={true} style={{order: id}} className="text-decoration-none d-block rounded-20 bg-black-secondary creators-card custom-p-20 position-relative">
